# LegacyEntitlementDefApi

All URIs are relative to *https://api.beamable.com*

| Method | HTTP request | Description |
|------------- | ------------- | -------------|
| [**createDefinition**](LegacyEntitlementDefApi.md#createDefinition) | **POST** /basic/legacy-entitlement-defs |  |


<a name="createDefinition"></a>
# **createDefinition**
> EmptyResponse createDefinition().modifyEntitlementDefinitionRequest(modifyEntitlementDefinitionRequest).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling LegacyEntitlementDefApi#createDefinition");
