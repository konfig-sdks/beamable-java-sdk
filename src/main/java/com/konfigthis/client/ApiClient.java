...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.beamable.com";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("api", new ApiKeyAuth("header", "X-DE-SIGNATURE"));
        authentications.put("scope", new ApiKeyAuth("header", "X-DE-SCOPE"));
        authentications.put("user", new HttpBearerAuth("bearer"));
        authentications.put("userRequired", new ApiKeyAuth("header", "X-DE-GAMERTAG"));
        ...
        if (configuration != null) {
            if (configuration.api != null) {
                this.setApi(configuration.api);
            }
            if (configuration.scope != null) {
                this.setScope(configuration.scope);
            }
            if (configuration.userRequired != null) {
                this.setUserRequired(configuration.userRequired);
            }
    ...
    public String getApi() {
        return ((ApiKeyAuth) this.getAuthentication("api")).getApiKey();
    }

    public void setApi(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("api")).setApiKey(apiKey);
    }

    public void setApiPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("api")).setApiKeyPrefix(prefix);
    }
    public String getScope() {
        return ((ApiKeyAuth) this.getAuthentication("scope")).getApiKey();
    }

    public void setScope(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("scope")).setApiKey(apiKey);
    }

    public void setScopePrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("scope")).setApiKeyPrefix(prefix);
    }
    public String getUserRequired() {
        return ((ApiKeyAuth) this.getAuthentication("userRequired")).getApiKey();
    }

    public void setUserRequired(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("userRequired")).setApiKey(apiKey);
    }

    public void setUserRequiredPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("userRequired")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.beamable.com)
