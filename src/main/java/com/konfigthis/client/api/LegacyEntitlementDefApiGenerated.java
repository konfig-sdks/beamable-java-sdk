...
public class LegacyEntitlementDefApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public LegacyEntitlementDefApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public LegacyEntitlementDefApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call createDefinitionCall(ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createDefinitionValidateBeforeCall(ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest, final ApiCallback _callback) throws ApiException {
        return createDefinitionCall(modifyEntitlementDefinitionRequest, _callback);

    }


    private ApiResponse<EmptyResponse> createDefinitionWithHttpInfo(ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest) throws ApiException {
        okhttp3.Call localVarCall = createDefinitionValidateBeforeCall(modifyEntitlementDefinitionRequest, null);
        Type localVarReturnType = new TypeToken<EmptyResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createDefinitionAsync(ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest, final ApiCallback<EmptyResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = createDefinitionValidateBeforeCall(modifyEntitlementDefinitionRequest, _callback);
        Type localVarReturnType = new TypeToken<EmptyResponse>(){}.getType();
    ...
    public class CreateDefinitionRequestBuilder {
        ...
        private CreateDefinitionRequestBuilder() {
        }
         ...
         */
        public CreateDefinitionRequestBuilder symbol(String symbol) {
            this.symbol = symbol;
            return this;
        }
         ...
         * @return CreateDefinitionRequestBuilder
         */
        public CreateDefinitionRequestBuilder request(EntitlementDefRequest request) {
        ...
        public EmptyResponse execute() throws ApiException {
            ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest = buildBodyParams();
            ApiResponse<EmptyResponse> localVarResp = createDefinitionWithHttpInfo(modifyEntitlementDefinitionRequest);
        ...
        public ApiResponse<EmptyResponse> executeWithHttpInfo() throws ApiException {
            ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest = buildBodyParams();
            return createDefinitionWithHttpInfo(modifyEntitlementDefinitionRequest);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<EmptyResponse> _callback) throws ApiException {
            ModifyEntitlementDefinitionRequest modifyEntitlementDefinitionRequest = buildBodyParams();
            return createDefinitionAsync(modifyEntitlementDefinitionRequest, _callback);
        }
    }
     ...
     */
    public CreateDefinitionRequestBuilder createDefinition() throws IllegalArgumentException {
        return new CreateDefinitionRequestBuilder();
    }
}
