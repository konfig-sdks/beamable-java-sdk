...
public class UploadRequest {
  ...
  public UploadRequest objectKey(String objectKey) {
  ...
  **/
  ...
  public UploadRequest lastModified(Integer lastModified) {
  ...
  **/
  ...
  public UploadRequest checksum(String checksum) {
  ...
  **/
  ...
  public UploadRequest sizeInBytes(Integer sizeInBytes) {
  ...
  **/
  ...
  public UploadRequest metadata(List<MetadataPair> metadata) {
  ...
  public UploadRequest addMetadataItem(MetadataPair metadataItem) {
  ...
  **/
   ...
   * @return the UploadRequest instance itself
   */
  public UploadRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objectKey, uploadRequest.objectKey) &&
        Objects.equals(this.lastModified, uploadRequest.lastModified) &&
        Objects.equals(this.checksum, uploadRequest.checksum) &&
        Objects.equals(this.sizeInBytes, uploadRequest.sizeInBytes) &&
        Objects.equals(this.metadata, uploadRequest.metadata)&&
        Objects.equals(this.additionalProperties, uploadRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objectKey, lastModified, checksum, sizeInBytes, metadata, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UploadRequest>() {
           ...
           public UploadRequest read(JsonReader in) throws IOException {
             ...
             UploadRequest instance = thisAdapter.fromJsonTree(jsonObj);
