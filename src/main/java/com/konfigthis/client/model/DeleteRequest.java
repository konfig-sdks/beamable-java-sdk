...
public class DeleteRequest {
  ...
  public DeleteRequest id(Integer id) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DeleteRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DeleteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
