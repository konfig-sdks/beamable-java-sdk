...
public class QueryResponse {
  ...
  public QueryResponse results(List<String> results) {
  ...
  public QueryResponse addResultsItem(String resultsItem) {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!QueryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
