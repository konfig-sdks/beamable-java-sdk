...
public class Player {
  ...
  **/
   ...
   * @return the Player instance itself
   */
  public Player putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playerId, player.playerId)&&
        Objects.equals(this.additionalProperties, player.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Player>() {
           ...
           public Player read(JsonReader in) throws IOException {
             ...
             Player instance = thisAdapter.fromJsonTree(jsonObj);
