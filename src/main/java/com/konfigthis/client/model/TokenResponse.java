...
public class TokenResponse {
  ...
  **/
  ...
  public TokenResponse scopes(List<String> scopes) {
  ...
  public TokenResponse addScopesItem(String scopesItem) {
    if (this.scopes == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessToken, expiresIn, refreshToken, scopes, tokenType, additionalProperties);
  }
