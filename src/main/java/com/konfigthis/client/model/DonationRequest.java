...
public class DonationRequest {
  public static final String SERIALIZED_NAME_TIME_REQUESTED = "timeRequested";
  @SerializedName(SERIALIZED_NAME_TIME_REQUESTED)
  private Integer timeRequested;

  public static final String SERIALIZED_NAME_PROGRESS = "progress";
  @SerializedName(SERIALIZED_NAME_PROGRESS)
  private List<DonationEntry> progress = null;
  ...
  public DonationRequest timeRequested(Integer timeRequested) {
  ...
  **/
  ...
  public void setTimeRequested(Integer timeRequested) {
  ...
  public DonationRequest progress(List<DonationEntry> progress) {
  ...
  public DonationRequest addProgressItem(DonationEntry progressItem) {
  ...
  **/
  ...
  public List<DonationEntry> getProgress() {
    return progress;
  }


  public void setProgress(List<DonationEntry> progress) {
  ...
  public DonationRequest satisfied(Boolean satisfied) {
  ...
  **/
  ...
  public DonationRequest playerId(Integer playerId) {
  ...
  **/
  ...
  public DonationRequest currency(Currency currency) {
  ...
  **/
   ...
   * @return the DonationRequest instance itself
   */
  public DonationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.timeRequested, donationRequest.timeRequested) &&
        Objects.equals(this.progress, donationRequest.progress) &&
        Objects.equals(this.satisfied, donationRequest.satisfied) &&
        Objects.equals(this.playerId, donationRequest.playerId) &&
        Objects.equals(this.currency, donationRequest.currency)&&
        Objects.equals(this.additionalProperties, donationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(timeRequested, progress, satisfied, playerId, currency, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("timeRequested");
    ...
    openapiRequiredFields.add("timeRequested");
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DonationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      if (jsonObj.get("progress") != null && !jsonObj.get("progress").isJsonNull()) {
        ...
        if (jsonArrayprogress != null) {
          ...
          for (int i = 0; i < jsonArrayprogress.size(); i++) {
            DonationEntry.validateJsonObject(jsonArrayprogress.get(i).getAsJsonObject());
          };
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DonationRequest>() {
           ...
           public DonationRequest read(JsonReader in) throws IOException {
             ...
             DonationRequest instance = thisAdapter.fromJsonTree(jsonObj);
