...
public class StatsResponse {
  ...
  public StatsResponse id(Long id) {
  ...
  **/
  ...
  public StatsResponse stats(Map<String, Object> stats) {
  ...
  public StatsResponse putStatsItem(String key, Object statsItem) {
    if (this.stats == null) {
  ...
  **/
   ...
   * @return the StatsResponse instance itself
   */
  public StatsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, statsResponse.id) &&
        Objects.equals(this.stats, statsResponse.stats)&&
        Objects.equals(this.additionalProperties, statsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, stats, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to StatsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StatsResponse>() {
           ...
           public StatsResponse read(JsonReader in) throws IOException {
             ...
             StatsResponse instance = thisAdapter.fromJsonTree(jsonObj);
