...
public class ItemDeleteRequest {
  ...
  public ItemDeleteRequest contentId(String contentId) {
  ...
  **/
  ...
  public ItemDeleteRequest id(Long id) {
  ...
  **/
   ...
   * @return the ItemDeleteRequest instance itself
   */
  public ItemDeleteRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.contentId, itemDeleteRequest.contentId) &&
        Objects.equals(this.id, itemDeleteRequest.id)&&
        Objects.equals(this.additionalProperties, itemDeleteRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(contentId, id, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemDeleteRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemDeleteRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ItemDeleteRequest.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ItemDeleteRequest>() {
           ...
           public ItemDeleteRequest read(JsonReader in) throws IOException {
             ...
             ItemDeleteRequest instance = thisAdapter.fromJsonTree(jsonObj);
