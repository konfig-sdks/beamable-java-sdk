...
public class RoleMapping {
  ...
  public RoleMapping projectId(String projectId) {
  ...
  **/
   ...
   * @return the RoleMapping instance itself
   */
  public RoleMapping putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.projectId, roleMapping.projectId) &&
        Objects.equals(this.role, roleMapping.role)&&
        Objects.equals(this.additionalProperties, roleMapping.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(projectId, role, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RoleMapping.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RoleMapping>() {
           ...
           public RoleMapping read(JsonReader in) throws IOException {
             ...
             RoleMapping instance = thisAdapter.fromJsonTree(jsonObj);
