...
public class Social {
  ...
  private List<Player> blocked = null;

  public Social() {
  }

  public Social playerId(String playerId) {
  ...
  **/
  ...
  public Social friends(List<Friend> friends) {
  ...
  public Social addFriendsItem(Friend friendsItem) {
  ...
  **/
  ...
  public Social blocked(List<Player> blocked) {
  ...
  public Social addBlockedItem(Player blockedItem) {
  ...
  **/
  ...
  public List<Player> getBlocked() {
    return blocked;
  }


  public void setBlocked(List<Player> blocked) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playerId, social.playerId) &&
        Objects.equals(this.friends, social.friends) &&
        Objects.equals(this.blocked, social.blocked)&&
        Objects.equals(this.additionalProperties, social.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playerId, friends, blocked, additionalProperties);
  }
      ...
      if (jsonObj.get("friends") != null && !jsonObj.get("friends").isJsonNull()) {
        ...
        if (jsonArrayfriends != null) {
          ...
          for (int i = 0; i < jsonArrayfriends.size(); i++) {
            Friend.validateJsonObject(jsonArrayfriends.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("blocked") != null && !jsonObj.get("blocked").isJsonNull()) {
        JsonArray jsonArrayblocked = jsonObj.getAsJsonArray("blocked");
        if (jsonArrayblocked != null) {
          // ensure the json data is an array
          if (!jsonObj.get("blocked").isJsonArray()) {
          ...
          // validate the optional field `blocked` (array)
          for (int i = 0; i < jsonArrayblocked.size(); i++) {
            Player.validateJsonObject(jsonArrayblocked.get(i).getAsJsonObject());
          };
        }
      }
  }
