...
public class Promotion {
  ...
  **/
  ...
  public Promotion source(Promotable source) {
  ...
  **/
  ...
  public Promotion destination(Promotable destination) {
  ...
  **/
   ...
   * @return the Promotion instance itself
   */
  public Promotion putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, promotion.id) &&
        Objects.equals(this.source, promotion.source) &&
        Objects.equals(this.destination, promotion.destination)&&
        Objects.equals(this.additionalProperties, promotion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, source, destination, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Promotion
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Promotion.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Promotion>() {
           ...
           public Promotion read(JsonReader in) throws IOException {
             ...
             Promotion instance = thisAdapter.fromJsonTree(jsonObj);
