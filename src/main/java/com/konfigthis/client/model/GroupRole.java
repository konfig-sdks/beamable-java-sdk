...
public class GroupRole {
  ...
  **/
   ...
   * @return the GroupRole instance itself
   */
  public GroupRole putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, groupRole.name) &&
        Objects.equals(this.permissions, groupRole.permissions)&&
        Objects.equals(this.additionalProperties, groupRole.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupRole>() {
           ...
           public GroupRole read(JsonReader in) throws IOException {
             ...
             GroupRole instance = thisAdapter.fromJsonTree(jsonObj);
