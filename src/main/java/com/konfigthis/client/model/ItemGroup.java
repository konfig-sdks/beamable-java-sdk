...
public class ItemGroup {
  ...
  **/
   ...
   * @return the ItemGroup instance itself
   */
  public ItemGroup putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, itemGroup.id) &&
        Objects.equals(this.items, itemGroup.items)&&
        Objects.equals(this.additionalProperties, itemGroup.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, items, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ItemGroup
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ItemGroup.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : ItemGroup.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ItemGroup>() {
           ...
           public ItemGroup read(JsonReader in) throws IOException {
             ...
             ItemGroup instance = thisAdapter.fromJsonTree(jsonObj);
