...
public class Period {
  ...
  public Period start(String start) {
  ...
  **/
   ...
   * @return the Period instance itself
   */
  public Period putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.start, period.start) &&
        ...
        Objects.equals(this.additionalProperties, period.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Period
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Period.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Period>() {
           ...
           public Period read(JsonReader in) throws IOException {
             ...
             Period instance = thisAdapter.fromJsonTree(jsonObj);
