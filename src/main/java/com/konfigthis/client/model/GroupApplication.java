...
public class GroupApplication {
  ...
  public GroupApplication subGroup(Integer subGroup) {
  ...
  **/
   ...
   * @return the GroupApplication instance itself
   */
  public GroupApplication putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.subGroup, groupApplication.subGroup)&&
        Objects.equals(this.additionalProperties, groupApplication.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupApplication
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupApplication.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupApplication>() {
           ...
           public GroupApplication read(JsonReader in) throws IOException {
             ...
             GroupApplication instance = thisAdapter.fromJsonTree(jsonObj);
